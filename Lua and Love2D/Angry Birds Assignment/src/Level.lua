...
function Level:init()
    ...
    -- spawn aliens to try and destroy
    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH - 80, VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2, 'Alien'))

    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH - 120, (VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2) - 145, 'Alien'))
    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH - 80, (VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2) - 145, 'Alien'))
    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH - 40, (VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2) - 145, 'Alien'))

    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH / 2 - 40, VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2, 'Alien'))
    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH / 2 - 40, (VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2) - ALIEN_SIZE, 'Alien'))
    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH / 2 - 40, (VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2) - ALIEN_SIZE * 2, 'Alien'))

    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH / 2 + 95, (VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2) - 110, 'Alien'))
    table.insert(self.aliens, Alien(self.world, 'square', VIRTUAL_WIDTH / 2 + 95, (VIRTUAL_HEIGHT - TILE_SIZE - ALIEN_SIZE / 2) - 110 - ALIEN_SIZE, 'Alien'))
    ...
    table.insert(self.obstacles, Obstacle(self.world, 'vertical',
        VIRTUAL_WIDTH / 2, VIRTUAL_HEIGHT - 35 - 110 / 2))
    table.insert(self.obstacles, Obstacle(self.world, 'vertical',
        VIRTUAL_WIDTH / 2 - 80, VIRTUAL_HEIGHT - 35 - 110 / 2))
    table.insert(self.obstacles, Obstacle(self.world, 'horizontal',
        VIRTUAL_WIDTH / 2 - 40, VIRTUAL_HEIGHT - 35 - 110 - 35 / 2))

    table.insert(self.obstacles, Obstacle(self.world, 'vertical',
        VIRTUAL_WIDTH / 2 + 95, VIRTUAL_HEIGHT - 35 - 110 / 2))
...
function Level:update(dt)
    ...
    if self.launchMarker.launched then
        ...
        if self.launchMarker.alien1 ~= nil and self.launchMarker.alien2 ~= nil then
            ...
            if xPos < 0 or ((math.abs(xVel) + math.abs(yVel) < 12) and (math.abs(xVel1) + math.abs(yVel1) < 12) and (math.abs(xVel2) + math.abs(yVel2) < 12)) then
            ...
            if xPos < 0 or (math.abs(xVel) + math.abs(yVel) < 12)then
                self.launchMarker.alien.body:destroy()
                self.launchMarker = AlienLaunchMarker(self.world)
