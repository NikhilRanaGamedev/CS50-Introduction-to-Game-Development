...
function LevelMaker.createMap(level)
    ...
    -- whether we want to enable a locked brick or not
    lockedBrick = math.random(1, 2) == 1 and true or false
    local lockedBrickSet = false
    local lockedBrickPosition = math.random(1, numCols)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if lockedBrick and lockedBrickPosition == x and lockedBrickSet == false then
                b.color = 6
                b.tier = 0
                lockedBrickSet = true
                lockedBrickInfo = b
