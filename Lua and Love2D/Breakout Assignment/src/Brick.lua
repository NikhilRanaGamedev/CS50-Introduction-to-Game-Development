...
function Brick:hit(ballPowerup, keyPowerup)
    ...
    if ballPowerup.powerupActive == false and ballPowerup.powerupCollected == false then
        ballPowerup.hitCounter = ballPowerup.hitCounter + 1
    end
